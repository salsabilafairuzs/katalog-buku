...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h3><i class="fas fa-address-book"></i> Penerbit</h3>
      </div>
      <div class="col-sm-6">
  ...
  <div class="card">
    <div class="card-header">
      ...
      <div class="card-tools">
        <a href="index.php?include=tambah-penerbit" class="btn btn-sm btn-info float-right"><i class="fas fa-plus"></i> Tambah Penerbit</a>
      </div>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
      <div class="col-md-12">
        <form action="index.php?include=penerbit" method="post">
          <div class="row">
