...
<section class="content">
  <div class="card">
      ...
      <table class="table table-bordered">
        ...
        <tbody>
          ...
          if (isset($katakunci_kategori) && !empty($katakunci_kategori)) {
            // $sql_k .= " where `kategori_buku` LIKE '%$katakunci_kategori_kategori%' ";
    ...
    // if (!empty($katakunci_kategori_kategori)){
    //     $sql_jum .= " where `kategori_buku` LIKE '%$katakunci_kategori_kategori%' ";
    // } 
      ...
      <ul class="pagination pagination-sm m-0 float-right">
        ...
        if ($jum_halaman == 0) {
          ...
          if ($halaman != 1) {
            ...
            echo "<li class='page-item'><a class='page-link' 
                    href='index.php?include=kategori-buku&halaman=$sebelum'>«</a></li>";
          }
          ...
          if ($halaman != $jum_halaman) {
            echo "<li class='page-item'><a class='page-link' 
                        href='index.php?include=kategori-buku&halaman=$setelah'>»</a></li>";
            echo "<li class='page-item'><a class='page-link' 
                        href='index.php?include=kategori-buku&halaman=$jum_halaman'>Last</a></li>";
          }
        } ?>
      </ul>
    </div>
