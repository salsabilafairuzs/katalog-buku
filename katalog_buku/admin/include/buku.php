...
if (isset($_GET['aksi']) && isset($_POST['katakunci_buku'])) {
  if ($_GET['aksi'] == 'cari') {
    $_SESSION['katakunci_buku'] = $_POST['katakunci_buku'];
    ...
    <div class="card-body">
        ...
        <form method="post" action="index.php?include=buku&aksi=cari">
          <div class="row">
            <div class="col-md-4 bottom-10">
              <input type="text" class="form-control" id="kata_kunci" name="katakunci_buku">
            </div>
      ...
      <table class="table table-bordered">
        ...
        <tbody>
          ...
          if (isset($katakunci_buku) && !empty($katakunci_buku)) {
            $sql_b .= " WHERE `k`.`kategori_buku` LIKE '%$katakunci_buku%'";
          }
          ...
          ?>
            <tr>
              ...
              <td align="center">
                <a href="index.php?include=edit-buku&data=<?php echo $id_buku; ?>" class="btn btn-xs btn-info" title="Edit"><i class="fas 
                          fa-edit"></i>edit</a>
                <a href="index.php?include=detail-buku&data=<?php echo $id_buku; ?>" class="btn btn-xs btn-info" title="Detail"><i class="fas 
                          fa-eye"></i>detail</a>
                <a href="javascript:if(confirm('Anda yakin ingin menghapus data 
                          <?php echo $judul; ?>?')) window.location.href = 'index.php?include=buku&aksi=hapus&data=<?php echo $id_buku; ?>&notif=hapusberhasil'" class="btn btn-xs btn-warning"><i class="fas fa-trash" title="Hapus"></i></a>
              </td>
            </tr>
          <?php $no++;
          } ?>
