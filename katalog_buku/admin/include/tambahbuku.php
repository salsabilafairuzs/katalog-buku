<!-- Content Header (Page header) -->
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php?inculude=buku">Data Buku</a></li>
    ...
    <div class="card card-info">
      <div class="card-header">
        ...
        <div class="card-tools">
          <a href="index.php?inculude=buku" class="btn btn-sm btn-warning float-right">
    ...
    <?php }?>
      ...
      <form class="form-horizontal" action="index.php?include=konfirmasi-tambah-buku"
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-7">
              <div class="input-group date">
                <input type="text" class="form-control" name="tahun_terbit" id="tahun_terbit"  autocomplete="off"
                value="">
