...
if(isset($_GET['data'])){
    ...
    //get data penerbit
	  $sql_d = "select `penerbit` from `penerbit` where `id_penerbit` = '$id_penerbit'";
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php?include=penerbit" class="btn btn-sm btn-warning float-right"></a></li>
